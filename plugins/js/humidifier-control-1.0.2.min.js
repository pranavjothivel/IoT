...
function CurrentStatusCallback(data, status) {
    if (status == "success") {
        ...
        setInterval(CurrentStatusRetriever, 100000);
        
        // if following does not work use data.result === true
        if (data.result) {
...
function CurrentHumidityCallback(data, status) {
    if (status == "success") {
        ...
        setInterval(CurrentHumidityRetriever, 100000);
    }
}
...
function CurrentRunPointCallback(data, status) {
    if (status == "success") {
        ...
        setInterval(CurrentRunPoint, 100000);
